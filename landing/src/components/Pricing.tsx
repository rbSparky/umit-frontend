        ...
        >
          ...
          >
            ...
            >
              ...
              ></div>
              <ul className={`w-full text-center text-sm font-bold`}>
          ...
          <div
            className={`flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none bg-background mt-4`}
          >
            <div
              className={`flex-1 bg-background text-gray-600 rounded-t rounded-b-none overflow-hidden shadow`}
            >
              <div className={`w-full p-8 font-bold text-3xl text-center border-b-4`}>
                {secondPlan?.name}
              </div>
            ...
            <div
              className={`flex-none mt-auto bg-background rounded-b rounded-t-none overflow-hidden shadow p-6`}
            >
              <div className={`w-full pt-6 text-4xl font-bold text-center text-gray-600`}>
                {secondPlan?.price}
